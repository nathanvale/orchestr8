...
Create adapter interfaces and implementations for external service dependencies to establish clear trust boundaries in our testing architecture. This pattern allows us to mock only at the system boundaries while using real implementations for internal components.

## Acceptance Criteria

- [ ] Define adapter interfaces for all external services (email, S3, payment, etc.)
