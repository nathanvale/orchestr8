...
Identify and consolidate repetitive mock patterns across the codebase into
reusable mock factories. This reduces code duplication, improves consistency,
and makes mock management more maintainable while preparing for eventual mock
reduction.

Create centralized mock factories that can generate consistent, well-structured
mocks for common patterns, reducing the overall complexity and maintenance
burden of the mocking infrastructure.
...
The implementation must demonstrate that mock patterns can be effectively
consolidated without losing flexibility, providing a foundation for easier mock
management and future reduction efforts.
