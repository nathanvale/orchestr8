...
Configure Vitest to aggressively terminate processes that exceed timeouts or
don't respond to termination signals.

## Background

Vitest's default termination behavior is too gentle, allowing processes to
linger. We need to configure more aggressive termination policies and timeouts.
...
Balance between aggressive termination and allowing legitimate long-running
tests. Consider making timeouts configurable per test.
