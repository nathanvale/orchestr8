...
- Large workflow validation (<100ms)
...
- Minimum 90% code coverage for schema package
- 100% coverage for error formatting utilities
- 100% coverage for JSON Schema generation
